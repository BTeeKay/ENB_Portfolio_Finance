...
const MarketBox = ({ marketShare, stockNameFromSearch, getStockData, addShareToPortfolio }) => {
    ...
    return (
        <>
            ...
            <MarketDetail stock={marketShare} addShareToPortfolio={addShareToPortfolio} />
        </>
